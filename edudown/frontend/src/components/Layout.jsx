...
const ROL_LABELS = {
  ...
  enfermera: 'Enfermera de Sala terapéutica',
...
const NAV_ITEMS = [
  { path: '/pacientes', label: 'Personas atendidas', icon: <IconUsers />, roles: ['enfermera', 'medico_kinesiologo', 'medico_fonoaudiologo', 'admin_sede', 'admin_institucion'] },
  { path: '/dashboard', label: 'Dashboard', icon: <IconChart />, roles: ['admin_institucion'] },
  { path: '/mapa', label: 'Mapa de Salas', icon: <IconMap />, roles: ['enfermera', 'medico_kinesiologo', 'medico_fonoaudiologo', 'admin_sede', 'auxiliar_limpieza', 'jefe_auxiliares', 'admin_institucion'] },
